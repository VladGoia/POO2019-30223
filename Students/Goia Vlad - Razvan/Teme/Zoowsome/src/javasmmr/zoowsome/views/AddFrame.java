...
public class AddFrame extends ZooFrame {
	...
	public AddFrame(String title) {
		...
		slPanel.putConstraint(SpringLayout.NORTH, btnAnimal, 130, SpringLayout.NORTH, pan);   
		slPanel.putConstraint(SpringLayout.WEST, btnAnimal, 90, SpringLayout.WEST, pan);   
		pan.add(btnAnimal);

		btnEmployee = new JButton("Employee");   
		slPanel.putConstraint(SpringLayout.NORTH, btnEmployee, 170, SpringLayout.NORTH, pan);   
